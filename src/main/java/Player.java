...
public class Player {
    ...
    protected ArrayList<Card[]> pair(){
        ...
        for(Card[] cards : Combination.combinationUtil(this.card.toArray(new Card[this.card.size()]), data, 0, this.card.size()-1, 0, 2)){
    ...
    protected ArrayList<Card[]> thrice(){
        ...
        ArrayList<Card[]> result = new ArrayList<>();
        for(Card[] cards : Combination.combinationUtil(this.card.toArray(new Card[this.card.size()]), data, 0, this.card.size()-1, 0, 3)){
    ...
    protected ArrayList<Card[]> bomb(){
        ...
        ArrayList<Card[]> result = new ArrayList<>();
        for(Card[] cards : Combination.combinationUtil(this.card.toArray(new Card[this.card.size()]), data, 0, this.card.size()-1, 0, 4)){
    ...
    protected ArrayList<Card[]> flush(){
        ...
        ArrayList<Card[]> result = new ArrayList<>();
        for(Card[] cards : Combination.combinationUtil(this.card.toArray(new Card[this.card.size()]), data, 0, this.card.size()-1, 0, 5)){
            String temp = cards[0].icon;
            boolean same = true;
            for(Card x:cards){
                if(!x.icon.equals(temp)){
                    same = false;
                    break;
                }
            }
